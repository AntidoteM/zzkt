<template>
  <div class="page-logon">
    <section class="logon_navbar">
      <div class="page-nav-operate page-nav-back" @click="exit">
        <i class="iconfont icon-fanhui"></i>
      </div>
      <h3 class="page-nav-title" style="font-size: 20px;">注册</h3>
    </section>
      ...
      <div class="logon_container">
        ...
        <div class="logon_form">
          <div class="logon_form-wrapper">
            ...
            <input class="logon_form-input" type="text" placeholder="请输入手机号" v-model="phone" />
            <span class="logon_iconfont clear_btn" @click="phone=''">
              <i class="iconfont icon-cuowu"></i>
            </span>
          </div>
          <!-- <div class="logon_form-wrapper">
            <label class="logon_form-label" for>验证码</label>
            <input
              style="width:50%"
          ...
          <div class="logon_signin">
            <input class="logon_form-input logon_button" type="button" value="注册" @click="commit" />
          </div>
        </div>
      </div>
    </div>
